 ...
 */
public class CommentSetMapper extends AbstractMapper<Comment.CommentSetter, Comment.CommentSetter> {
    ...
    @Override
    protected Comment.CommentSetter mapLogic(Comment.CommentSetter commentSetter) throws Exception {
